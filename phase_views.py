...
def _render_checklist_item(
    ...
    with st.expander(f"{badge}  {label}{suffix}",
        ...
        pass_help_reasons = []
        if material_blocked:
            pass_help_reasons.append(t("alert.material_required"))
        if image_blocked:
            pass_help_reasons.append(t("alert.image_required"))
        pass_help = "\n".join(pass_help_reasons) if pass_help_reasons else None
