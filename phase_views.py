...
def _render_checklist_item(
    ...
    with st.expander(f"{badge}  {label}{suffix}",
        ...
        pass_help = None
        if pass_disabled:
            if material_blocked and image_blocked:
                pass_help = f"🔒 {t('alert.material_required')} {t('alert.image_required')}"
            elif material_blocked:
                pass_help = f"🔒 {t('alert.material_required')}"
            else:
                pass_help = f"🔒 {t('alert.image_required')}"
        ...
        rework_help = t("misc.disabled_rework") if rework_disabled else None
