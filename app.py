...
with st.sidebar:
    ...
    if projects:
        # ⚡ Bolt Optimization: Pre-compute dictionary for O(1) selectbox lookups.
        # Streamlit calls format_func for every option in the list.
        # Doing an O(N) traversal inside format_func creates an O(N^2) bottleneck.
