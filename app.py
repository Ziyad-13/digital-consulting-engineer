...
with st.sidebar:
    ...
    if selected_id is not None:
        ...
        # ⚡ Bolt: Batch database query to avoid N+1 inside the loop
...
if selected_id is None:
    ...
    # ⚡ Bolt: Batch database query already fetched in sidebar, but since
    # it's out of scope here (and for safety in standalone renders), fetch again:
