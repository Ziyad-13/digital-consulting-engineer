...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "misc.disabled_pass_both": {"en": "Cannot pass: missing material and image proof.",
                                "ar": "لا يمكن الاجتياز: ينقص المواد وصورة الإثبات."},
    "misc.disabled_pass_material": {"en": "Cannot pass: missing material match.",
                                    "ar": "لا يمكن الاجتياز: ينقص مطابقة المواد."},
    "misc.disabled_pass_image": {"en": "Cannot pass: missing image proof.",
                                 "ar": "لا يمكن الاجتياز: ينقص صورة الإثبات."},
    "misc.disabled_rework": {"en": "Item is not in FAIL state.",
                             "ar": "البند ليس في حالة فشل."},
