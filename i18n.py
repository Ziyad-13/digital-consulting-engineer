...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "misc.disabled_rework": {"en": "Rework can only be started if the item has failed.",
                             "ar": "لا يمكن بدء إعادة العمل إلا إذا فشل البند."},
    "misc.disabled_pass_mat": {"en": "Cannot pass: Material match pending or failed.",
                               "ar": "لا يمكن الاعتماد: مطابقة المواد معلقة أو فاشلة."},
    "misc.disabled_pass_img": {"en": "Cannot pass: Required proof image is missing.",
                               "ar": "لا يمكن الاعتماد: صورة الإثبات المطلوبة مفقودة."},
    "misc.disabled_pass_both": {"en": "Cannot pass: Missing proof image and material mismatch.",
                                "ar": "لا يمكن الاعتماد: صورة الإثبات مفقودة ومواد غير مطابقة."},
