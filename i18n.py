...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "misc.disabled_rework": {"en": "Rework cycle can only be started when the item has FAILED.",
                             "ar": "لا يمكن بدء دورة إعادة العمل إلا عند فشل البند."},
    "misc.disabled_pass_mat": {"en": "Cannot mark PASS: Pending material match.",
                               "ar": "لا يمكن الاعتماد: بانتظار مطابقة المواد."},
    "misc.disabled_pass_img": {"en": "Cannot mark PASS: Photo proof required.",
                               "ar": "لا يمكن الاعتماد: يلزم رفع صورة الإثبات."},
    "misc.disabled_pass_both": {"en": "Cannot mark PASS: Photo proof and material match required.",
                                "ar": "لا يمكن الاعتماد: يلزم رفع صورة الإثبات ومطابقة المواد."},
