...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "btn.mark_pass.disabled_help": {"en": "Cannot pass: Check missing materials or images",
                                    "ar": "لا يمكن الاعتماد: تأكد من المواد أو الصور الناقصة"},
    "btn.start_rework.disabled_help": {"en": "Item must be marked FAIL to start rework",
                                       "ar": "يجب تسجيل فشل البند أولاً لبدء إعادة العمل"},
